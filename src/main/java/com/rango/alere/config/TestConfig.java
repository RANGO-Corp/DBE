...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        UserRegisterDTO dto = new UserRegisterDTO("DOADOR", "TESTE", "doador@gmail.com", "teste123", "teste123", "11999999999", true, false, true,  endDto);
        UserRegisterDTO dto2 = new UserRegisterDTO("RECEPTOR", "TESTE", "receptor@gmail.com", "teste123", "teste123", "11999999999",false , true, true,  endDto);
        UserRegisterDTO dto3 = new UserRegisterDTO("USER", "TESTE", "user@gmail.com", "teste123", "teste123", "11999999999", true, true, true,  endDto);
        ...
        alimentoFacade.registerAlimento(aliDto, user2);
        alimentoFacade.registerAlimento(aliDto1, user2);
        alimentoFacade.registerAlimento(aliDto2, user2);
        alimentoFacade.registerAlimento(aliDto3, user2);
